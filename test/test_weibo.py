...
url = "https://weibo.cn/1191262305/follow"
...
for page in range(1, page_num + 1):
    url = "https://weibo.cn/1191262305/follow?page={}"
    ...
    for i in range(len(s)):
        ...
        res.append(url)
        client.lpush("weibo_redis:start_urls", url)
    print(page)
...
# while True:
#     data = client.lpop('weibo_redis:items')
#     if not data:
#         print("结束")
#         break
